...
function mockEmployees(length = 24) {
    return ([...Array(length)].map(() => {
        ...
        return ({
            ...
            position: sample(['Conserje', 'Seguridad', 'Jardinero', 'Servicio']),
...
function mockEmployee(id) {
    ...
    return ({
        ...
        paymentMethod: { 
            ...
            paymentMethodIdentification: faker.random.numeric(7),
...
export { mockEmployees, mockEmployee };