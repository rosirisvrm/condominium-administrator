...
const initialState = {
    ...
    loadingLayoutNotifications: false,
}
...
export const notificationSlice = createSlice({
    ...
    reducers: {
        ...
        setLoadingLayoutNotifications: (state, action) => {
            state.loadingLayoutNotifications = action.payload;
        },
    }
})
